...
export default function Organization() {
  ...
  const wings = [
    ...
    { id: 3, titleEn: 'Kisan Morcha', titleHi: 'किसान मोर्चा', descEn: 'Working for the welfare of farmers in the district.', descHi: 'जिले के किसानों के कल्याण हेतु कार्यरत।' },
